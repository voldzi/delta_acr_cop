...
describe("COP PWA service worker routing", () => {
  ...
  it("keeps the current and immediately previous PWA release caches", () => {
    const serviceWorker = loadServiceWorkerContext();
    const keys = [
      "cop-pwa-offline-20260712-8:shell",
      "cop-pwa-offline-20260712-8:runtime",
      "cop-pwa-offline-20260712-7:shell",
      "cop-pwa-offline-20260712-7:runtime",
      "cop-pwa-offline-20260712-6:shell",
      "cop-pwa-offline-20260712-6:runtime",
      "cop-pwa-offline-20260712-5:shell",
      "cop-pwa-offline-20260712-5:runtime",
      "cop-pwa-offline-20260712-4:shell",
      "cop-pwa-offline-20260712-4:runtime",
      "cop-pwa-offline-20260712-3:shell",
      "cop-pwa-offline-20260712-3:runtime",
      "cop-pwa-offline-20260712-2:shell",
      "cop-pwa-offline-20260712-2:runtime",
