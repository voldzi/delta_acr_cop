...
- [Symbol Resolve Request](symbol-resolve-request.schema.json)
- [Symbol Resolve Response](symbol-resolve-response.schema.json)
- [AI COP Query](ai-cop-query.schema.json)
