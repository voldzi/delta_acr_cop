...
| `docs/api.md` | [api.md](api.md), [api/00_INDEX.md](api/00_INDEX.md), [integration/00_INDEX.md](integration/00_INDEX.md), [mobile/02_COP_DEVICE_API.md](mobile/02_COP_DEVICE_API.md), [mobile/03_DEVICE_BRIDGE_PROTOCOL.md](mobile/03_DEVICE_BRIDGE_PROTOCOL.md), legacy REST guide [mobile/01_NATIVE_IOS_IPADOS_APP.md](mobile/01_NATIVE_IOS_IPADOS_APP.md) |
